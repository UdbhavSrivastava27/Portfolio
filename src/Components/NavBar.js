  ...
  return (
    <>
      <div className="flex relative  justify-center" id="navbar">
        <img src={us} className="h-24 m-4 absolute left-0" alt="pic" />
        <div
          className=" p-3 mx-4 rounded-lg h-12 hidden md:flex items-center justify-center bg-slate-50 mt-5 border-2 shadow-md shadow-slate-300 
       
      "
        >
          <ul className=" flex flex-row mx-4  text-lg ">
            <li className="mr-8 hover:scale-110 cursor-pointer hover:text-gray-500">
              Home
            </li>
            <li
              className="mr-8 transition-all ease-in-out hover:scale-110 cursor-pointer
           hover:text-gray-500
          "
            >
        ...
        <div className="md:hidden lg:hidden -mr-[75%] ">
          {!toggle ? (
            ...
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="w-8 h-8 m-6 mr-32 cursor-pointer "
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            <div className=" relat">
              <div className=" absolute  mr-20">
                <ul className=" flex flex-col font-semibold bg-gray-200 p-4 rounded-md ">
                  ...
                  <li className=" mt-2 p-2 transition-all ease-in-out hover:scale-110 cursor-pointer">
                    <a href="/#about">About Me</a>
                  </li>
                  <li className=" p-2 mt-2  transition-all ease-in-out hover:scale-110 cursor-pointer">
                    <a href="/#skills">Skills</a>
                  </li>
                  <li className=" p-2 mt-2 transition-all ease-in-out hover:scale-110 cursor-pointer">
                    <a href="/#portfolio">Portfolio</a>
